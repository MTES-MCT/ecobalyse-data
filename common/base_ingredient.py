"""Inference of baseIngredient and the organic flag from an alias."""
...
def infer_organic(alias: str) -> bool:
    """True iff the alias contains the literal token `organic`."""
    return "-organic-" in f"-{alias}-"
